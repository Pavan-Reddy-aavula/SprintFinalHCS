...
public class AdminServiceTests {
	...
	public void testviewAppointment1()throws java.text.ParseException{
		...
		appointmentList.add(new Appointment(1,"Appointment Sample 1" ,sdf1 ,12,"bloodtest"));
		
		SimpleDateFormat sdf2 = new SimpleDateFormat("yyy-MM-dd");
		Date d1 = sdf2.parse("2020-04-02");
		appointmentList.add(new Appointment(2,"Appointment Sample 2",sdf2,13,"bp"));
		
		SimpleDateFormat sdf3 = new SimpleDateFormat("yyy-MM-dd");
		Date d2= sdf3.parse("2020-04-03");
		appointmentList.add(new Appointment(3,"Appointment Sample 3",sdf3,14,"sugar"));
		
		Mockito.when(ap.findById(appointmentList)).thenReturn(appointmentList);
		
		List<Appointment> returnedData = ap.findById(appointmentList);
	...
	public void testviewAppointment2() throws java.text.ParseException{
		...
		appointmentList.add(new Appointment(1,"Appointment Status1",sdf1,12,"bloodtest"));
		
		
		SimpleDateFormat sdf2 = new SimpleDateFormat("yyy-MM-dd");
		Date d2 = sdf2.parse("2020-04-05");
		appointmentList.add(new Appointment(2,"Appointment Status2",sdf2,13,"bp"));
		
		
		SimpleDateFormat sdf3 = new SimpleDateFormat("yyy-MM-dd");
		Date d3 = sdf3.parse("2020-04-06");
		appointmentList.add(new Appointment(3,"Appointment Status3",sdf3,14,"sugar"));
	...
	public void updateAppointment() throws java.text.ParseException{
		...
		Appointment a = new Appointment(4,"Appointment Status4",sdf4,15,"tt");
		ap.findById(4);
		ap.save(a);
