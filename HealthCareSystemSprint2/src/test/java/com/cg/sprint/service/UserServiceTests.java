...
public class UserServiceTests {
	...
	public void testviewTestclass(){
		...
		List<Testclass> result = userService.viewTestclass(12);
	...
	public void addAppointment() throws java.text.ParseException{
		...
		Appointment appointment = new Appointment(4,"Appointment Status",sdf1,15,"sugar" );
	...
	public void viewAppointment() throws java.text.ParseException{
	    ...
	    Appointment appointmentid = new Appointment(1,"Appointment Status",sdf,12,"bp");
